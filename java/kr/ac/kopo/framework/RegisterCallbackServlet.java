...
public class RegisterCallbackServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (idTokenString == null || idTokenString.isEmpty()) {
            response.sendRedirect("/ReserveSeat/loginForm.jsp?error=missing_token");
            return;
        }
        ...
        try {
            ...
            if (idToken != null) {
                ...
                if (member == null) {
                    ...
                    response.sendRedirect("/ReserveSeat/member/register.jsp");
                } else {
                ...
                // ID 토큰이 유효하지 않음
                response.sendRedirect("/ReserveSeat/loginForm.jsp?error=invalid_token");
            }
        } catch (Exception e) {
            e.printStackTrace();
            response.sendRedirect("/ReserveSeat/loginForm.jsp?error=exception");
        }
    }
}
